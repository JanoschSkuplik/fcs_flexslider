 ...
 * Content elements
 */
//define('fscSlider','Sdsdsd');

$GLOBALS['fcsSlider']['STARTTEMPLATE'] = 'flexslider_start';
$GLOBALS['fcsSlider']['ENDTEMPLATE'] = 'flexslider_end';
$GLOBALS['fcsSlider']['LISTTEMPLATE'] = true;
